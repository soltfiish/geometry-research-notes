...
- [Interactive geometry gallery](gallery/index.html): download this package and open this file in a browser. No installation or network connection is required. GitHub's file view shows HTML source rather than running the gallery.
